...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Wayline — Wayfinding for public space" },
      {
        name: "description",
        content:
          "Wayline is a wayfinding studio. We plan how people move through airports, stations and precincts — then design, make and install the signage that guides them.",
      },
      { name: "author", content: "Wayline Studio" },
      { property: "og:title", content: "Wayline — Wayfinding for public space" },
      {
        property: "og:description",
        content:
          "Planning, designing, making and installing wayfinding for airports, stations and precincts.",
      },
